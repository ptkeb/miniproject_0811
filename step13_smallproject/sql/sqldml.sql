...
--decoration 카펫
insert into seasonality values(4011, '카펫', 100000, '30*60*15', 'white', 1);
insert into seasonality values(4012, '카펫A', 300000, '40*60*20', 'red', 2);
insert into seasonality values(4013, '카펫B', 1000000, '45*60*25', 'dark red', 3);


--decoration 커튼
insert into seasonality values(4021, '커튼', 100300, '30*60*15', 'white', 1);
insert into seasonality values(4022, '커튼A', 100500, '40*60*20', 'red', 2);
insert into seasonality values(4023, '커튼B', 100200, '45*60*25', 'dark blue', 3);
