...
public class ProductDAO {
	...
	public static ArrayList getAllProduct() throws SQLException{
		...
		public static ArrayList<ProductDTO> PackList(int pnum, String pname, int price, String standard, String color, int priority){
...
//				sizea= sizea-1;
//			}
			return PackList(a2.getProductPnum(),a2.getProductPname(),a2.getProductPrice(),a2.getProductStandard(),a2.getProductColor(),a2.getProductPriority());
		}
