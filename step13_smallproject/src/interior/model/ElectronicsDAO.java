...
public class ElectronicsDAO {
	...
	public static ElectronicsDTO getElectronics(int pnum) throws SQLException {
		...
		try {
			...
			if (rset.next()) {
				Electronics = new ElectronicsDTO(rset.getInt(1), rset.getString(2), rset.getInt(3), rset.getString(4),
	...
	public static ArrayList<ElectronicsDTO> getAllElectronics() throws SQLException {
		...
		try {
			...
			while (rset.next()) {
				list.add(new ElectronicsDTO(rset.getInt(1), rset.getString(2), rset.getInt(3), rset.getString(4),
						rset.getString(5), rset.getInt(6)));
			}
		} finally {
			DBUtil.close(con, pstmt, rset);
